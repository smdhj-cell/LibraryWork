...
static void on_ancs_c_evt(ble_ancs_c_evt_t * p_evt)
{
    ...
    {
        case BLE_ANCS_C_EVT_DISCOVERY_COMPLETE:	//连接成功
        ...
        case BLE_ANCS_C_EVT_NOTIF:	//接收到IOS通知时所做的处理,获取详细的通知信息
                                           ...
                                           ret_code_t          event_result)
{
    ...
    {
        case DM_EVT_CONNECTION:	//判断设备是否连接
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            ...
            APP_ERROR_CHECK(err_code);
			nrf_delay_ms(100);
			apple_notification_setup();	//连接成功使能ANCS通知指示
