...
static int set_message(unsigned char *dst, unsigned char *src, int src_len)
{
    int i = 0;
    char checksum1 = 0;
    char checksum2 = 0;
...
static int hdbd_gps_inject_time(GpsUtcTime time, int64_t timeReference, int uncertainty)
{
    (void)(timeReference);
    (void)(uncertainty);
    ...
    ALOGI("[%s:%d]: inject time %04d/%02d/%02d %02d:%02d:%02d", __FUNCTION__, __LINE__, 1900 + utcNtp->tm_year, 1 + utcNtp->tm_mon, utcNtp->tm_mday, utcNtp->tm_hour, utcNtp->tm_min, utcNtp->tm_sec);
    ...
    ALOGI("%02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X", message[0], message[1], message[2],
          message[3], message[4], message[5], message[6], message[7], message[8], message[9], message[10], message[11], message[12], message[13], message[14], message[15], message[16], message[17],
          message[18], message[19], message[20], message[21], message[22], message[23], message[24], message[25], message[26], message[27], message[28], message[29]);
...

{
    ...
    ALOGI("%02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X", message[0], message[1], message[2], message[3], message[4],
          message[5], message[6], message[7], message[8], message[9], message[10], message[11], message[12], message[13], message[14], message[15], message[16], message[17], message[18], message[19],
          message[20], message[21], message[22], message[23], message[24]);
}
